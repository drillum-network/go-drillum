...
// Defaults contains default settings for use on the Drillum main net.
var Defaults = Config{
...
type Config struct {
	...
	// If nil, the Drillum main net block is used.
	...
	// canonical chain of all remote peers. Setting the option makes gdrill verify the
	...
	// send-transaction variants. The unit is drill.
	RPCTxFeeCap float64
