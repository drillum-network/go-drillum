...
import (
	...
	jsassets "github.com/drillum-network/go-drillum/eth/tracers/js/internal/tracers"
)

var assetTracers = make(map[string]string)

// init retrieves the JavaScript transaction tracers included in go-drillum.
func init() {
	var err error
