...
// Syncing provides information when this nodes starts synchronising with the Drillum network and when it's finished.
...
type SyncingResult struct {
	...
	Status  drillum.SyncProgress `json:"status"`
}
