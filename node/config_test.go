...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gdrill.ipc", false, filepath.Join(os.TempDir(), "gdrill.ipc")},
		{"data", "gdrill.ipc", false, "data/gdrill.ipc"},
		{"data", "./gdrill.ipc", false, "./gdrill.ipc"},
		{"data", "/gdrill.ipc", false, "/gdrill.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gdrill.ipc", true, `\\.\pipe\gdrill.ipc`},
		{"data", "gdrill.ipc", true, `\\.\pipe\gdrill.ipc`},
		{"data", `\\.\pipe\gdrill.ipc`, true, `\\.\pipe\gdrill.ipc`},
	}
