...
import (
	...
	"github.com/drillum-network/go-drillum/common/bitutil"
	"github.com/drillum-network/go-drillum/light"
)

const (
	// bloomServiceThreads is the number of goroutines used globally by an Drillum
...
func (eth *LightDrillum) startBloomHandlers(sectionSize uint64) {
