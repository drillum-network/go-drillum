...
# 1. install gdrill for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gdrill
# 5. create gdrill, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable DRILLUM_SOCKET
...
!define GROUPNAME "Drillum"
!define APPNAME "Gdrill"
!define DESCRIPTION "Official Go implementation of the Drillum protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gdrill is installed global
