Name "gdrill ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/drillum-network/go-drillum/issues"
!define UPDATEURL "https://github.com/drillum-network/go-drillum/releases"
!define ABOUTURL "https://github.com/drillum-network/go-drillum#drillum-go"
...
# Install gdrill binary
Section "Gdrill" GDRILL_IDX
  SetOutPath $INSTDIR
  file {{.Gdrill}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gdrill.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gdrill.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gdrill incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gdrill outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gdrill UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gdrill incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gdrill.exe" "" "" "Drillum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gdrill outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gdrill.exe" "" "" "Drillum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gdrill UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gdrill.exe" "" "" "Drillum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "DRILLUM_SOCKET" "R" "HKLM" "\\.\pipe\gdrill.ipc"
  ${EnvVarUpdate} $0 "DRILLUM_SOCKET" "A" "HKLM" "\\.\pipe\gdrill.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GDRILL_IDX}
    SectionGetSize ${GDRILL_IDX} $0
