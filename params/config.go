...
type ChainConfig struct {
	...
	DrillBlock          *big.Int `json:"drillBlock,omitempty"`
...
func (c *ChainConfig) String() string {
	...
	if c.DrillBlock != nil {
		banner += fmt.Sprintf(" - Drill:                        %-8v (https://github.com/ethereum/execution-specs/blob/master/network-upgrades/mainnet-upgrades/drill.md)\n", c.GrayGlacierBlock)
	}
...
func (c *ChainConfig) IsDrill(num *big.Int) bool {
	return isForked(c.DrillBlock, num)
}
...
func (c *ChainConfig) CheckConfigForkOrder() error {
	...
	for _, cur := range []fork{
		...
		{name: "drillBlock", block: c.DrillBlock},
...
func (c *ChainConfig) checkCompatible(newcfg *ChainConfig, head *big.Int) *ConfigCompatError {
	...
	if isForkIncompatible(c.DrillBlock, newcfg.DrillBlock, head) {
		return newCompatError("Drill fork block", c.DrillBlock, newcfg.DrillBlock)
	}
