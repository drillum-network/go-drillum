...
// Package ethclient provides a client for the Drillum RPC API.
package ethclient
...
// Client defines typed wrappers for the Drillum RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, drillum.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*drillum.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (drillum.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q drillum.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q drillum.FilterQuery, ch chan<- types.Log) (drillum.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q drillum.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg drillum.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg drillum.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg drillum.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*drillum.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg drillum.CallMsg) (uint64, error) {
...
func toCallArg(msg drillum.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *drillum.SyncProgress {
	if p == nil {
		return nil
	}
	return &drillum.SyncProgress{
