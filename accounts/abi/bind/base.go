...
// valid Drillum transaction.
type TransactOpts struct {
	From   common.Address // Drillum account to send the transaction from
...
// Drillum network. It contains a collection of methods that are used by the
// higher level contract bindings to operate.
type BoundContract struct {
	address    common.Address     // Deployment address of the contract on the Drillum blockchain
	abi        abi.ABI            // Reflect based ABI to access the correct Drillum methods
...
// DeployContract deploys a contract onto the Drillum blockchain and binds the
...
func (c *BoundContract) Call(opts *CallOpts, results *[]interface{}, method string, params ...interface{}) error {
	...
	var (
		msg    = drillum.CallMsg{From: opts.From, To: &c.address, Data: input}
