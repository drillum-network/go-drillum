...
// Package bind generates Drillum contract Go bindings.
//
// Detailed usage document and tutorial available on the go-drillum Wiki page:
// https://github.com/drillum-network/go-drillum/wiki/Native-DApps:-Go-bindings-to-Drillum-contracts
package bind
