...
pruning. Remember don't start the Gdrill without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "gdrill snapshot prune-state --help" for more details.
`
