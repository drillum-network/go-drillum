...
type Prefetcher interface {
	// Prefetch processes the state changes according to the Drillum rules by running
...
type Processor interface {
	// Process processes the state changes according to the Drillum rules by running
