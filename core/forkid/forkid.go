...
// NewID calculates the Drillum fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Drillum fork ID from an existing chain instance.
