...
// Package types contains data types related to Drillum consensus.
package types
...
// Header represents a block header in the Drillum blockchain.
type Header struct {
...
// Block represents an entire block in the Drillum blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the Drillum RLP block format.
