...
// setting up a new or managing an existing Drillum private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Drillum private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Drillum network down to  |")
	...
	log.Info("Administering Drillum network", "name", w.network)
