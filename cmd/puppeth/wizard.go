...
type wizard struct {
	...
	services map[string][]string   // Drillum services known to be running on servers
...
// converts it to an Drillum address. If an empty line is entered, the default
// value is returned.
