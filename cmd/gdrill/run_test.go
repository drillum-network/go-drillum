...
import (
	...
	"github.com/drillum-network/go-drillum/internal/cmdtest"
	"github.com/drillum-network/go-drillum/rpc"
)

type testgdrill struct {
	*cmdtest.TestCmd
...
func init() {
	// Run the app if we've been exec'd as "gdrill-test" in runGdrill.
	reexec.Register("gdrill-test", func() {
...
// spawns gdrill with the given command line args. If the args don't set --datadir, the
// child g gets a temporary data directory.
func runGdrill(t *testing.T, args ...string) *testgdrill {
	tt := &testgdrill{}
	...
	// Boot "gdrill". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("gdrill-test", args...)
