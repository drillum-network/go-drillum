...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Manage Drillum presale wallets",
		ArgsUsage: "",
		Description: `
    gdrill wallet import /path/to/my/presale.wallet

will prompt for your password and imports your drill presale account.
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Drillum presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
				...
				Description: `
	gdrill wallet [options] /path/to/my/presale.wallet
...
between drillum nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gdrill account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gdrill account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another drillum instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := gdrillConfig{Node: defaultNodeConfig()}
	// Load config file.
