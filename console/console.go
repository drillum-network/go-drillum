...
import (
	...
	"github.com/drillum-network/go-drillum/internal/jsre"
	"github.com/drillum-network/go-drillum/internal/jsre/deps"
	"github.com/drillum-network/go-drillum/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Drillum requests through
...
// Welcome show summary of current Gdrill instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gdrill JavaScript console!\n\n"

	// Print some generic Gdrill metadata
