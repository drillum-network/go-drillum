...
// mapped from textual names used in the tests below to actual Drillum private
...
// address retrieves the Drillum address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Drillum address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/drillum-network/go-drillum/issues/17593). Whilst this
