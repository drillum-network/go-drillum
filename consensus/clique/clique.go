...
// ecrecover extracts the Drillum account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Drillum address
...
// Drillum testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Drillum address of the signing key
...
// Author implements consensus.Engine, returning the Drillum address recovered
