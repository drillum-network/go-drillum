...
// Package graphql provides a GraphQL interface to Drillum node data.
package graphql
...
// Account represents an Drillum account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an Drillum transaction.
...
// Block represents an Drillum block.
...
type CallData struct {
	From                 *common.Address // The Drillum address the call is from.
	To                   *common.Address // The Drillum address the call is to.
